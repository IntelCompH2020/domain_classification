...
class GetKeywordsWindow(QtWidgets.QDialog):
    def __init__(self, tm):
        ...
        self.info_button_selected_keywords.setIconSize(
            BUTTONS_SCALE * QSize(self.info_button_selected_keywords.width(),
    ...
    def update_params(self):
        """Updates the keywords parameters that are going to be used in the getting of the keywords based on the values read from the table within the GUI's "Get keywords" window that has been specified by the user.
        """
    ...
    def clicked_select_keywords(self):
        ...
        # Show warning message in case the user clicks on the "Select keywords" button without having previously written the words that he wants to use as keywords
        ...
        # Show warning message in case no tag for the file in which the subcorpus conformed based on the selected keywords is going to be saved has been selected
